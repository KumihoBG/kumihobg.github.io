...
const profileTemplate = (changePassword) => html`
${navTemplate()}
<div class="container">
  <div class="main-body">
    <!-- Breadcrumb -->
    ...
    <button @click=${changePassword} type="button" id="submitNewPass" name="submitNewPass">Change Password</button>
  </div>
...
export async function profilePage(context) {
  context.render(profileTemplate(changePassword));
  setUserNav();
}
