  ...
  <div id="world">
    ...
    <div class="legend">
      ...
      <ul @click=${toggleLegend} id="races">
        ...
        <div id="brotherhood" class="info" style="display: none;">The vocation of the warriors of light is to be
          defenders
          of the people,
          guardians of history and immortal fighters against evil in the Bulgarian lands. They have magical skills and
          ancient knowledge, which makes them one of the strongest enemies of the forest fairies, brutes and Svetovid.
          The
        ...
        <div id="brutes" class="info" style="display: none;">They are led by their master Michael - a servant of
          Svetovid.
          They are
        ...
        <div id="zmey" class="info" style="display: none;">Paroria is a place in today's Strandzha mountain. There is
          the
          refuge of
          the irresistibly beautiful Zmey Vladimir. His power is expressed in control and possession of natural forces.
          A
        ...
        <div id="mountains" class="info" style="display: none;">This was the name of the Rhodopes Mountains in the
          Middle
          Ages. It was
        ...
        <div id="tarnovgrad" class="info" style="display: none;">This is today's city of Veliko Tarnovo. It was called
          so
          in the Middle
          Ages. It became the most important political, economic, cultural and religious center of Bulgaria at that
          time.
        </div>
      </ul>
    </div>
